...
vars:       equ 0x7e00+200h  ; Variables (multiple of 256)
running:    equ 0x7e7e+200h  ; Running status
line:       equ 0x7e80+200h  ; Line input
program:    equ 0x7f00+200h  ; Program address
