...
bpbTotalSectorsBig      DD      2880               ; 0x20
...
bsUnused                DB      0               ; 0x25
bsExtBootSignature      DB      28h               ; 0x26
bsSerialNumber          DD      12345678h               ; 0x27
...
ProgramName     db      "UKERNEL COM"   ; name and extension each must be
