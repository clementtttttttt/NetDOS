...
kdata:
    ...
    .temp db 0
    .lookup_table dw 0
        db "1234567890-=",8h,9h,"qwertyuiop[]",10,0x9e,"asdfghjkl;",27h,'`',0x7a,"\zxcvbnm,./",0,0,0,'',0x7c
        times (0xe5-0x3b) db 0
    .lookup_table_shift dw 0
        db "!@#$%^&*()_+",8h,9h,"QWERTYUIOP{}",10,0,"ASDFGHJKL:",22h,0x2d,0x7a,0x7c,"ZXCVBNM",'<','>','?',0,0,0,'',0x7c
        times (0xe5-0x3b) db 0
end_of_kdata:
